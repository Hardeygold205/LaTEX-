...
% The results obtained from the geoelectric sections showed that there are three subsurface geologic layers, namely: the topsoil, weathered layer (comprises of clay/sandy clay and laterite), and fractured basement/fresh bedrock. The topsoil resistivity ranged from 56 to 1222 ohms.m with a mean value of 366.8 ohms.m. The weathered layer has resistivity range of 16 to 1168 Ohm.m with a mean value of 246.1 Ohm.m and thickness that varies from 0.7 to 6.2 m. The delineated weathered and fractured basement columns constituted the aquifer units.
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.9\textwidth]{Nigeria_Study_Country.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1.0\textwidth]{Picture2.png}
...
\begin{longtable}{|>{\raggedright\arraybackslash}m{1.5cm}|>{\raggedright\arraybackslash}m{3cm}|>{\raggedright\arraybackslash}m{3cm}|>{\raggedright\arraybackslash}m{3cm}|>{\raggedright\arraybackslash}m{2cm}|>{\raggedright\arraybackslash}m{1.5cm}|}
    ...
    \endlastfoot
        ...
        VES 5 & Topsoil & 345.7 & 0.8 & 0.8 & H \\[0.3cm] \cline{2-5}
              ...
              & Fresh Basement & 539.7 & Infinity & Infinity &  \\[0.3cm] \cline{2-5}
        \hline
        VES 6 & Topsoil & 368.7 & 0.8 & 0.8 & H \\[0.3cm] \cline{2-5}
              & Weathered Basement & 30.7 & 8.2 & 8.9 &  \\[0.3cm] \cline{2-5}
              & Fresh Basement & 596.1 & Infinity & Infinity &  \\[0.3cm] \cline{2-5}
        \hline
        VES 7 & Topsoil & 315.5 & 1.0 & 1.0 & H \\[0.3cm] \cline{2-5}
              & Weathered Basement & 40.1 & 9.9 & 10.9 &  \\[0.3cm] \cline{2-5}
              & Fresh Basement & 834.5 & Infinity & Infinity &  \\[0.3cm] \cline{2-5}
        \hline
        VES 8 & Topsoil & 1222.0 & 1.0 & 1.0 & H \\[0.3cm] \cline{2-5}
              & Weathered Basement & 13.7 & 2.6 & 3.6 &  \\[0.3cm] \cline{2-5}
              & Fresh Basement & 707.8 & Infinity & Infinity &  \\[0.3cm] \cline{2-5}
        \hline
        VES 9 & Topsoil & 445.4 & 0.5 & 0.5 & HKH \\[0.3cm] \cline{2-5}
              & Fractured Basement & 43.4 & 1.4 & 1.9 &  \\[0.3cm] \cline{2-5}
              & Fractured / Weathered Basement & 166.7 & 11.4 & 13.2 &  \\[0.3cm] \cline{2-5}
              & Weathered Basement & 18.6 & 3.8 & 17.0 &  \\[0.3cm] \cline{2-5}
              & Fresh Basement & 433.9 & Infinity & Infinity &  \\[0.3cm] \cline{2-5}
        \hline
        VES 10 & Topsoil & 210.0 & 0.7 & 0.7 & H \\[0.3cm] \cline{2-5}
              & Weathered Basement & 70.0 & 4.8 & 5.5 &  \\[0.3cm] \cline{2-5}
              & Fresh Basement & 210.0 & Infinity & Infinity &  \\[0.3cm] \cline{2-5}
        \hline
\end{longtable}
